...
// =========== rd_close_all_nav() =================
function rd_close_all_nav() {
	rd_close_nav("tutorials");
	rd_close_nav("references");
	rd_close_nav("examples");
	rd_close_nav("translate");
	rd_close_nav("search");
	close_menu();
}
(function () {
	...
	if (window.addEventListener) {
		document.getElementById("main").addEventListener("click", rd_close_all_nav, true);
		m.addEventListener("click", rd_close_all_nav, true);
		document.getElementById("right").addEventListener("click", rd_close_all_nav, true);
	} else if (window.attachEvent) {
		document.getElementById("main").attachEvent("onclick", rd_close_all_nav);
		m.attachEvent("onclick", rd_close_all_nav);
		document.getElementById("right").attachEvent("onclick", rd_close_all_nav);
	}
...
function printPage() {
	...
	var css = "",
		i, j, c = document.getElementById("main").cloneNode(true);
